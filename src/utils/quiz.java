...
public class quiz {
    ...
    static String[][] qui = new String[10][5];
    ...
    public static String[][] setQuiz() {
        ...
        try {
            ...
            tests.stream().forEach((test) -> {
                list.add(test.getReponse());
            });
            System.out.println("the size is " + list.size());
            List<String> ls = getRandomElement(list, 4);

            for (int i = 0; i < 10; i++) {
                qui[i][0] = tests.get(i).getQuestion();

                qui[i][1] = ls.get(0);
                qui[i][2] = ls.get(1);
                qui[i][3] = ls.get(2);
                qui[i][4] = tests.get(i).getReponse();

                System.out.println(i + " : " + qui[0][0]);
                System.out.println(i + " : " + qui[0][1]);
                System.out.println(i + " : " + qui[0][2]);
                System.out.println(i + " : " + qui[0][3]);
    ...
    public static List<String> getRandomElement(List<String> list,
            int totalItems) {
