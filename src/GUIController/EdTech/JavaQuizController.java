...
import GUIController.EdTech.Quiz.Model;
...
import GUIController.EdTech.Quiz.MainController;
import utils.mail;
...
public class JavaQuizController implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        qpa = quiz.setQuiz();
        qca = answer.getAnswsers();

        map = new HashMap<Integer, String>();
        readqa(qaid);
        System.out.println("this shit q l" + qpa.length);
        System.out.println("this shit a l" + qca.length);
    ...
    public int calCorrectAnswer() {
        ...
        SendMail(Integer.toString(count));
        return count;
    }
    ...
    public void submit() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/GUIInterface/EdTech/Quiz/JavaLangFinaReport.fxml"));
    ...
    public void SendMail(String content) {
        String USER_NAME = "wafa.haoues@esprit.tn";  // GMail user name (just the part before "@gmail.com")
        String PASSWORD = "sekaioni192"; // GMail password
        String RECIPIENT = "wafa.haoues@esprit.tn";

        String from = USER_NAME;
        String pass = PASSWORD;
        String[] to = {RECIPIENT}; // list of recipient email addresses
        String subject = "You have completed the quiz test";
        String body = "your score is " + content;
        mail m = new mail();
