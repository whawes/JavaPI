...
public class Sujet {
    ...
    public Sujet(int sujet_id, int createur_id, String titre, String description, LocalDateTime date, int score, int vues) {
    ...
    public Sujet(int createur_id, String titre, String description, LocalDateTime date, int score, int vues) {
        this.createur_id = createur_id;
        this.titre = titre;
        this.description = description;
        this.date = date;
