...
public class Commentaire {
    ...
    public Commentaire(int commentaire_id, int sujet_id, int createur_id, String texte, LocalDateTime date, int score) {
    ...
    public Commentaire(int sujet_id, int createur_id, String texte, LocalDateTime date, int score) {
        this.sujet_id = sujet_id;
        this.createur_id = createur_id;
        this.texte = texte;
        this.date = date;
